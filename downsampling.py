...
clean_train_path = '/data/home/star/sgmse/sgmseFAttn/VoiceBankDEMAND16k/clean_trainset_28spk_wav'
noisy_train_path = '/data/home/star/sgmse/sgmseFAttn/VoiceBankDEMAND16k/noisy_trainset_28spk_wav'

clean_test_path  = '/data/home/star/sgmse/sgmseFAttn/VoiceBankDEMAND16k/clean_testset_wav'
noisy_test_path  = '/data/home/star/sgmse/sgmseFAttn/VoiceBankDEMAND16k/noisy_testset_wav'

resample_path    = '/data/home/star/MUSE-Speech-Enhancement/VB_DEMAND_16K'
...
def downsample_wave(clean_path, noisy_path, sample_rate=downsample_rate, phase='train'):
    ...
    tf = torchaudio.transforms.Resample(16000,sample_rate)
